...
Версия 0.1.0 (`android-v0.1.0`) подписана одноразовым ключом, который не
сохранился, поэтому 0.2.0 поверх неё не встаёт. Начиная с 0.2.0 все
версии подписаны одним ключом и обновляются поверх друг друга.
